...
const run = async () => {
  ...
  await Hero.create({
    ...
    githubUrl: "https://github.com/JAYsoni1018",
    linkedinUrl: "https://www.linkedin.com/in/jay-soni1303/",
  });

  console.log("Seeding about...");
  await About.create({
    biography:
      "Passionate about building AI-driven applications that solve real problems.",
    professionalSummary:
      "Experienced with RAG pipelines, LangChain, LangGraph, FastAPI, and full-stack development.",
  ...
  await Project.insertMany([
    {
      ...
      fullDescription:
        "<p>A real-time trading dashboard built with FastAPI and vanilla JS.</p>",
      technologies: ["FastAPI", "JavaScript", "WebSockets"],
      category: "Full Stack",
      githubUrl: "https://github.com/JAYsoni1018/nse-command-deck",
      featured: true,
      displayOrder: 0,
    },
    {
      ...
      fullDescription:
        "<p>An intelligent assistant for radiology image analysis.</p>",
  ...
  await SocialLink.insertMany([
    {
      platform: "GitHub",
      url: "https://github.com/JAYsoni1018",
      displayOrder: 0,
    },
    {
      platform: "LinkedIn",
      url: "https://www.linkedin.com/in/jay-soni1303/",
      displayOrder: 1,
    },
    { platform: "Email", url: "mailto:jaysoni1385@gmail.com", displayOrder: 2 },
  ]);
